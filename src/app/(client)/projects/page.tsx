  ...
  return (
    <>
      ...
      <div className="w-[90%] max-w-5xl mx-auto pt-2 md:pt-6 pb-12 text-[#7F6456] space-y-6 text-justify md:text-left leading-relaxed">
        ...
        <p>
          Through our relentless pursuit of excellence, Arkiwood has further solidified its position among the most trusted interior companies in Dubai, providing design solutions that turn spaces into inspiring places while also ensuring long-term value and customer satisfaction.
        </p>
      </div>
    </>
  );
